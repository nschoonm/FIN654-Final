...
- Value at Risk (VaR) represents our maximum expected loss with a certain confidence level and Expected Shortfall represents the expected loss in extreme cases, when the loss exceeds VaR
